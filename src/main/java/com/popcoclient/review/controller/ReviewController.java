...
public class ReviewController {
    ...
    @Operation(summary = "콘텐츠에 작성된 나의 리뷰", description = "콘텐츠에 작성된 나의 리뷰를 확인합니다.")
    @SecurityRequirement(name = "bearerAuth")
    @GetMapping("/contents/{contentId}/types/{type}/my")
    public ResponseEntity<ApiResponse<MyContentReviewResponseDto>> getMyReviewsByContent(
            @PathVariable Long contentId, @PathVariable String type) {
        Long userId = jwtProvider.getNullableUserId();
